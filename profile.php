...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top">
    ...
    <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#E5ECF9">
      ...
      <tr>
        ...
        <td align="center" style="padding: 5px;">
            ...
            <div style="font-size: 14px; font-weight: bold; color:#003366; margin-bottom: 5px;">Hi, i'm <?php echo $Username ?>!</div>
        ...
        <!-- Friend This User Button -->
        <form method="post" action="add_friend.php">
            <input type="hidden" name="friend_id" value="<?php echo $user ?>">
            <input type="submit" value="Friend This User">
        </form>
    ...
    <div style="font-size: 14px; font-weight: bold; margin-bottom: 10px; color: #444;">&#187; <a href="profile_videos.php?user=<?php echo $Username ?>">Public Videos</a></div>
